...
const TaskCard = ({task}) => {
  ...
  return (
    <>
        ...
        <div className="w-full border-t border-t-gray-200 my-2 "/>
        <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-3 ">
                <div className="flex gap-1 items-center text-sm text-gray-600 "><BiMessageAltDetail/>
                <span>{task?.activities?.length}</span>
                </div>

                <div className="flex gap-1 items-center text-sm text-gray-600 "><MdAttachFile/>
                <span>{task?.activities?.length}</span>
                </div>

                <div className="flex gap-1 items-center text-sm text-gray-600 "><FaList/>
                <span>{task?.activities?.length}</span>
                </div>
        ...
        {/* {SubTask} */}
        {task?.subTasks?.length > 0 ? ( <div className="py-4 border-gray-200">
